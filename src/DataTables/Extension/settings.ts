...
export enum DataGridExecutionActions {
  Delete="delete",
  Save="save",
  none="none",
}
...
export class AsDataTableExtensionSettings
{
  wrapHeaders:boolean = true
}
...
export interface IASK2DataTableSettings {
    ...
    // autogeneratedColumnDefaults: OptColumnExtended
    ...
    // applySortAndFilterToNewLine:boolean
