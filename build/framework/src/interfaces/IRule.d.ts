...
export interface IRule extends IRuleDefinition.Event {
    ...
    addListener(type: EventTimingOption, callback: (evt: CustomEvent<RuleEventDetails>) => void): void;
    dispatch(eventType: EventTimingOption): boolean;
    removeListener(type: EventTimingOption, callback: (evt: CustomEvent<RuleEventDetails>) => void): void;
}
