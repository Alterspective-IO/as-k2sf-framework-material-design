 ...
 * @returns
 */
export function executeK2RuleForEachRow(ruleConfigurationName, passPack, dataArray) {
 ...
 */
export function updateAllK2ControlsBoundToGridColumns(pack, dataObject) {
 ...
 * @param method
 */
export function implementK2ControlToGridAction(dataTable, k2ConfigurationName, method) {
...
//# sourceMappingURL=ControlExecutionHelpers.js.map