import { FormatType } from "asFramework/src/index";
import { k2StyleNameToJavascriptName } from "../../Common/StyleHelper";
export function applyK2FormatToFormatter(k2StyleObject, formatter, systemName, dataType) {
    if (!k2StyleObject)
        return undefined;
...
export function applyK2StyleToRenderer(k2StyleObject, renderer) {
...
//# sourceMappingURL=StyleRenderers.js.map