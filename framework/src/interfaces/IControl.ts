...
export interface IControl extends Omit<ControllerDefinition.Control, "properties" | "type" | "id">, IContainer {
  ...
  //  addListener(type:string, timing: EventTimingOption,callback: (evt: CustomEvent<ChangedEvent>) => void): void 
  // dispatch(type:string,timing: EventTimingOption,event: ChangedEvent): boolean 
  // removeListener(type:string, timing: EventTimingOption,callback: (evt: CustomEvent<ChangedEvent>) => void): void
