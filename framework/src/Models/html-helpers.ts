...
import { addItemToDropdownList, addListToDropdownList, IStaticListItem } from "./Helpers/ControlHelpers";
...
export function implementControlExtensions(control: Control) {
  ...
  switch (control.type) {
    case ControlType.DropDown:
      ...
      cx.addExtension({
        name: "appendItem", value: function addItemStaticItem(item: IStaticListItem) {
          addItemToDropdownList(item, control)
        }
      });

      cx.addExtension({
        name: "appendItems", value: function addItemStaticItem(items: Array<string>) {
          addListToDropdownList(items, control)
        }
      });
