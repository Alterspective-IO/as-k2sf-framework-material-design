...
import { getControlWidgetHTMLElement, getControlWidgetInstance, getWidgetType } from "./Helpers/ControlHelpers";
...
export class Control extends BaseItem<IControllerDefinition.Control, IContainer> implements IControl {
    ...
    private _widgetType: string | undefined;



    get controlWidgetHTMLElement(): HTMLElement | null {
        return getControlWidgetHTMLElement(this)
    }
    ...
    get widgetType(): string | undefined {
        if (this._widgetType) {
            return this._widgetType; // Return cached value if available
        }
        if(this.controlWidgetHTMLElement == null) return undefined;
        this._widgetType = getWidgetType(this.controlWidgetHTMLElement)
        return this._widgetType;
    }


    /**
     * Gets the K2 SmartForm Control Instance for this control
     * @returns K2 SmartForm Control Instance
     */
    widgetInstance(): any | undefined {
        return getControlWidgetInstance(this)
    }
...
export class ContentControl extends Control implements IContentControl {
    ...
    public set autoResize(value: boolean) {
        ...
        if (value == true) {
            ...
            //@ts-ignore
            if (!this._as!.iFrameResizer) {
                console.log("iFrameResizer not loaded");
                return;
            }
